...
<div class="row-fluid">
	...
	<div class="span4">
		...
		<p>Please fill out the following form with your login credentials:</p>
		    ...
		    <?php echo $form->passwordFieldRow($model, 'password',array('class'=>'span12',"hint"=>"Hint: You may login with <kbd>demo</kbd>/<kbd>demo</kbd> or <kbd>admin</kbd>/<kbd>admin</kbd>."));?>
