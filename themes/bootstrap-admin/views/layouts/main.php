    ...
    'items'=>array(
        ...
        array(
            ...
            'items'=>array(
                ...
                array('label'=>'Hola '.ucwords(strtolower(Yii::app()->user->getState("nombres"))), 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest),
...
?>
    ...
    <div class="container" id="app">
      <div class="row visible-desktop"><div class="span12" style="height:40px"></div></div>
