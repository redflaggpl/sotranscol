...
class Municipios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, departamentos_id', 'required'),
			array('id, departamentos_id', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, nombre, departamentos_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'departamentos' => array(self::BELONGS_TO, 'Departamentos', 'departamentos_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('departamentos_id',$this->departamentos_id);
